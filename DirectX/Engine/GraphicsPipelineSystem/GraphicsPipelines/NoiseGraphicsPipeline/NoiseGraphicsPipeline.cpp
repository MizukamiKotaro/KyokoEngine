#include "NoiseGraphicsPipeline.h"
#include "Engine/Base/DebugLog/DebugLog.h"
#include "GraphicsPipelineSystem/BlendModeConfig.h"
#include <cassert>

NoiseGraphicsPipeline::NoiseGraphicsPipeline()
{
	Initialize();
}

void NoiseGraphicsPipeline::InitializePSO()
{
	//DescriptorRange
	...
	pixelShaderBlob_ = CompileShader(L"Resources/Shaders/GraphicsShaders/NoiseShader/Noise.PS.hlsl", L"ps_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
