#include "NegaPosiInverseGraphicsPipeline.h"
#include "Engine/Base/DebugLog/DebugLog.h"
#include <cassert>

NegaPosiInverseGraphicsPipeline::NegaPosiInverseGraphicsPipeline()
{
	Initialize();
}

void NegaPosiInverseGraphicsPipeline::InitializePSO()
{
	//DescriptorRange
	...
	pixelShaderBlob_ = CompileShader(L"Resources/Shaders/GraphicsShaders/NegaPosiInverseShader/NegaPosiInverse.PS.hlsl", L"ps_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
