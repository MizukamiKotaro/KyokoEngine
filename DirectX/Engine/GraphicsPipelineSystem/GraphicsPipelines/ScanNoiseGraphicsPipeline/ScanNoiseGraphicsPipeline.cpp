#include "ScanNoiseGraphicsPipeline.h"
#include "Engine/Base/DebugLog/DebugLog.h"
#include <cassert>

ScanNoiseGraphicsPipeline::ScanNoiseGraphicsPipeline()
{
	Initialize();
}

void ScanNoiseGraphicsPipeline::InitializePSO()
{
	//DescriptorRange
	...
	pixelShaderBlob_ = CompileShader(L"Resources/Shaders/GraphicsShaders/ScanNoiseShader/ScanNoise.PS.hlsl", L"ps_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
