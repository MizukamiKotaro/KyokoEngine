...
void MMDGraphicsPipline::InitializePSO()
{
	//DescriptorRange
	...
	inputElementDescs[5].SemanticName = "SCOLOR";
	...
	inputElementDescs[6].SemanticName = "SCOLOR";
	inputElementDescs[6].SemanticIndex = 1;
	inputElementDescs[6].Format = DXGI_FORMAT_R32G32B32_FLOAT;
	inputElementDescs[6].AlignedByteOffset = D3D12_APPEND_ALIGNED_ELEMENT;
	inputElementDescs[7].SemanticName = "SHININESS";
	inputElementDescs[7].SemanticIndex = 0;
	inputElementDescs[7].Format = DXGI_FORMAT_R32_FLOAT;
	inputElementDescs[7].AlignedByteOffset = D3D12_APPEND_ALIGNED_ELEMENT;
	inputElementDescs[8].SemanticName = "TEXINDEX";
	inputElementDescs[8].SemanticIndex = 1;
	inputElementDescs[8].Format = DXGI_FORMAT_R32_SINT;
	inputElementDescs[8].AlignedByteOffset = D3D12_APPEND_ALIGNED_ELEMENT;
	inputElementDescs[9].SemanticName = "TEXINDEX";
	inputElementDescs[9].SemanticIndex = 2;
	inputElementDescs[9].Format = DXGI_FORMAT_R32_SINT;
	inputElementDescs[9].AlignedByteOffset = D3D12_APPEND_ALIGNED_ELEMENT;
	...
	//Shaderをコンパイルする
	vertexShaderBlob_ = CompileShader(L"Resources/Shaders/GraphicsShaders/MMDShader/MMD.VS.hlsl", L"vs_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
	assert(vertexShaderBlob_ != nullptr);

	pixelShaderBlob_ = CompileShader(L"Resources/Shaders/GraphicsShaders/MMDShader/MMD.PS.hlsl", L"ps_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
