...
ContrastGraphicsPipeline::ContrastGraphicsPipeline()
{
	Initialize();
}
...
void ContrastGraphicsPipeline::InitializePSO()
{
	...
	pixelShaderBlob_ = CompileShader(L"Resources/Shaders/GraphicsShaders/ContrastShader/Contrast.PS.hlsl", L"ps_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
