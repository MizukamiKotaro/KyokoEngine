#include "MMDMotionComputePipeline.h"
#include "Engine/Base/DebugLog/DebugLog.h"
#include <cassert>

MMDMotionComputePipeline::MMDMotionComputePipeline()
{
	Initialize();
}

void MMDMotionComputePipeline::InitializePSO()
{
	//DescriptorRange
	...
	//Shaderをコンパイルする
	computeShaderBlob_ = CompileShader(L"Resources/Shaders/ComputeShaders/MMDMotionShader/MMDMotion.CS.hlsl", L"cs_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
