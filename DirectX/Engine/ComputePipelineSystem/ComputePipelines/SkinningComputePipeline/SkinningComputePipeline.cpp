...
void SkinningComputePipeline::InitializePSO()
{
	...
	rootParameters[1].DescriptorTable.pDescriptorRanges = descriptorRange1; // Tableの中の配列を指定
	...
	rootParameters[2].DescriptorTable.pDescriptorRanges = descriptorRange2; // Tableの中の配列を指定
	rootParameters[2].DescriptorTable.NumDescriptorRanges = _countof(descriptorRange2); // Tableで利用する数
	...
	rootParameters[3].DescriptorTable.pDescriptorRanges = descriptorRange3; // Tableの中の配列を指定
	rootParameters[3].DescriptorTable.NumDescriptorRanges = _countof(descriptorRange3); // Tableで利用する数
