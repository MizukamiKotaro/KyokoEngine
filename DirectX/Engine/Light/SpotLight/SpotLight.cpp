...
ID3D12GraphicsCommandList* SpotLight::commandList_ = nullptr;
GraphicsPipelineManager* SpotLight::gpoManager_ = nullptr;
ModelDataManager* SpotLight::modelDataManager_ = nullptr;
